...
//	add_construction_kit("Test",/obj/item/weapon/crowbar,3)
	...
	add_construction_kit("Tank Dispenser",/obj/structure/dispenser,9)
	...
	add_construction_kit("DNA Modifier Access Console",/obj/machinery/dna_scannernew,6)
	...
	add_construction_kit("Chemistry Vendor",/obj/machinery/chem_dispenser,15)
	add_construction_kit("Mining Vendor",/obj/machinery/mineral/equipment_locker,15)
