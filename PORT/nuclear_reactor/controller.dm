/obj/machinery/power/nuclear_power/control
	...
	proc/generate_menu(mob/user)
		...
		<body style='background-colour=#8FB6FF;text-align=center;'>
		<center>
		<table border = 1 style='table-layout=fixed;font-family=Courier New;font-weight=bold;background-colour=black;border-colour=black;border-width=6px;'>
		<tr><td style='text-align=left;background-colour=yellow;'>Fissile Status:</td><td id='status' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Reaction Rate:</td><td id='rate' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Reaction Multiplier:</td><td id='multiplier' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Rod Insertion:</td><td id='insertion' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Temperature (K):</td><td id='temp' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Maintain Reaction:</td><td id='maintain' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Power Output:</td><td id='power' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		<tr><td style='text-align=left;background-colour=yellow;'>Safeties:</td><td id='safe' style='text-align=center; background-colour=yellow;'>LOADING...</td></tr>
		</table>
